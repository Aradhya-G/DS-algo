    ...
    extractMin() {
        ...
        while (n < this.heap.length) {
            ...
            if (rightIndex >= this.heap.length) {
                ...
                const LowestIndex = this.heap[leftIndex] < this.heap[rightIndex] ? leftIndex : rightIndex
                if (this.heap[LowestIndex] > this.heap[n])
                    break;

                [this.heap[LowestIndex], this.heap[n]] = [this.heap[n], this.heap[LowestIndex]]
                n = LowestIndex
            }
        }
    }
